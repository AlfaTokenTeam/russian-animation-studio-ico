...
import "./RussianAnimationStudio.sol";

contract RussianAnimationStudioPreSale {
    RussianAnimationStudio public token;
    ...
    function RussianAnimationStudioPreSale(
        RussianAnimationStudio _token,
        address _beneficiary,
        address _alfatokenteam
    ) {
        token = RussianAnimationStudio(_token);
